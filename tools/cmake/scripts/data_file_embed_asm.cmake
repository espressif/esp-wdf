...
function(make_and_append_size str size)
    string(MAKE_C_IDENTIFIER "${str}" symbol)
    append_line(".size ${symbol}, ${size}")
endfunction()
...
append_line(".int32 ${data_len}")
make_and_append_size("${varname}_length" "4")