# Designed to be included from an WDF app's CMakeLists.txt file
...
macro(project project_name)
    ...
    message(STATUS "Building ESP-WDF components for WASM")

    idf_build_process(wasm
    ...
    add_custom_command(OUTPUT ${project_wasm_src}
        ...
        VERBATIM)
    add_custom_target(_project_wasm_src DEPENDS "${project_wasm_src}")
    add_executable(${project_wasm} "${project_wasm_src}")
    add_dependencies(${project_wasm} _project_wasm_src)
