...
# Espressif Webassembly Development Framework (ESP-WDF) Project Configuration
#
"""
...
def write_makefile(deprecated_options, config, filename):
    CONFIG_HEADING = """#
# Automatically generated file. DO NOT EDIT.
# Espressif Webassembly Development Framework (ESP-WDF) Project Makefile Configuration
#
"""
...
def write_header(deprecated_options, config, filename):
    CONFIG_HEADING = """/*
 * Automatically generated file. DO NOT EDIT.
 * Espressif Webassembly Development Framework (ESP-WDF) Configuration Header
 */
#pragma once
"""
...
def write_cmake(deprecated_options, config, filename):
    with open(filename, 'w') as f:
        ...
        write("""#
# Automatically generated file. DO NOT EDIT.
# Espressif Webassembly Development Framework (ESP-WDF) Configuration cmake include file
#
""")
