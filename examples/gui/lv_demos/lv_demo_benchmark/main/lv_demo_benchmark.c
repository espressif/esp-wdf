...
static void multiple_labels_cb(void)
{
    ...
    if(hor_res * ver_res > 800 * 480) lv_obj_set_style_text_font(scr, lv_font_get_font(LV_FONT_BENCHMARK_MONTSERRAT_26_COMPR_AZ_FONT), 0);
    else if(hor_res * ver_res > 320 * 240) lv_obj_set_style_text_font(scr, lv_font_get_font(LV_FONT_BENCHMARK_MONTSERRAT_20_COMPR_AZ_FONT), 0);
    else lv_obj_set_style_text_font(scr, lv_font_get_font(LV_FONT_BENCHMARK_MONTSERRAT_14_COMPR_AZ_FONT), 0);
#else
    if(hor_res * ver_res > 800 * 480) lv_obj_set_style_text_font(scr, lv_font_get_font(LV_FONT_MONTSERRAT_26_FONT), 0);
    else if(hor_res * ver_res > 320 * 240) lv_obj_set_style_text_font(scr, lv_font_get_font(LV_FONT_MONTSERRAT_20_FONT), 0);
    else lv_obj_set_style_text_font(scr, lv_font_get_font(LV_FONT_MONTSERRAT_14_FONT), 0);
#endif
...
void lv_demo_benchmark(void)
{
    ...
    title = lv_label_create(lv_layer_top());
...
static void load_scene(uint32_t scene)
{
    ...
    lv_obj_set_style_bg_color(scr, lv_palette_lighten(LV_PALETTE_GREY, 4), 0);
    lv_obj_set_style_text_color(scr, lv_color_black(), 0);
    lv_obj_set_style_text_font(scr, lv_font_get_font(LV_FONT_MONTSERRAT_14_FONT), 0);
...
static void table_draw_task_event_cb(lv_event_t * e)
{
    ...
    lv_draw_task_get_data(t, LV_DRAW_TASK_DSC_BASE, &draw_dsc_base, sizeof(lv_draw_dsc_base_t));
    ...
    if(row == 0) {
        ...
        if(draw_dsc_fill) {
            lv_color_t color = lv_palette_darken(LV_PALETTE_BLUE_GREY, 4);
            lv_draw_fill_dsc_set_data(draw_dsc_fill, LV_DRAW_FILL_DSC_COLOR, &color, sizeof(color));
        }
        lv_draw_label_dsc_t * draw_dsc_label = lv_draw_task_get_label_dsc(t);
        if(draw_dsc_label) {
            lv_color_t label_color = lv_color_white();
            lv_draw_label_dsc_set_data(draw_dsc_label, LV_DRAW_LABEL_DSC_COLOR, &label_color, sizeof(label_color));
        }
    }
    else if(row == 1) {
        lv_draw_border_dsc_t * draw_dsc_border = lv_draw_task_get_border_dsc(t);
        if(draw_dsc_border) {
            lv_color_t border_color = lv_palette_darken(LV_PALETTE_BLUE_GREY, 4);
            int32_t width = 2; 
            lv_border_side_t side = LV_BORDER_SIDE_BOTTOM;
            lv_draw_border_dsc_set_data(draw_dsc_border, LV_DRAW_BORDER_DSC_COLOR, &border_color, sizeof(border_color));
            lv_draw_border_dsc_set_data(draw_dsc_border, LV_DRAW_BORDER_DSC_WIDTH, &width, sizeof(width));
            lv_draw_border_dsc_set_data(draw_dsc_border, LV_DRAW_BORDER_DSC_SIDE, &side, sizeof(lv_border_side_t));
        }
        lv_draw_label_dsc_t * draw_dsc_label = lv_draw_task_get_label_dsc(t);
        if(draw_dsc_label) {
            lv_color_t label_color = lv_palette_darken(LV_PALETTE_BLUE_GREY, 4); 
            lv_draw_label_dsc_set_data(draw_dsc_label, LV_DRAW_LABEL_DSC_COLOR, &label_color, sizeof(label_color));
        }
    }
...
#if LV_DEMO_BENCHMARK_ALIGNED_FONTS
    lv_obj_set_style_text_font(child, lv_font_get_font(LV_FONT_BENCHMARK_MONTSERRAT_24_COMPR_AZ_FONT), 0);
#else
    lv_obj_set_style_text_font(child, lv_font_get_font(LV_FONT_MONTSERRAT_24_FONT), 0);
#endif
...
#if LV_DEMO_BENCHMARK_ALIGNED_FONTS
    lv_obj_set_style_text_font(child, lv_font_get_font(LV_FONT_BENCHMARK_MONTSERRAT_14_COMPR_AZ_FONT), 0);
#else
    lv_obj_set_style_text_font(child, lv_font_get_font(LV_FONT_MONTSERRAT_14_FONT), 0);
#endif
