...
void lv_demo_stress(void)
{
    ...
    obj_test_timer = lv_timer_create(obj_test_task_cb, LV_DEMO_STRESS_TIME_STEP, NULL);
    lv_timer_ready(obj_test_timer); /*Prepare the test right now in first state change.*/
}
...
static void obj_test_task_cb(lv_timer_t * tmr)
{
    ...
    switch(g_state) {
        ...
        case 14:
            ...
            {
                msgbox_tmr = lv_timer_create(msgbox_delete, LV_DEMO_STRESS_TIME_STEP * 5 + 30, obj);
